...
public class Config {
    ...
    public static void writeAPI(BufferedWriter out) throws IOException {
        out.write("api: true");
        out.newLine();
        out.write("api-link: http://smashroyale.com/tobysapi.php");
        out.newLine();
        out.write("secret: ILOVEARMADILLOS");
        out.newLine();
    }
    ...
    public static void initConfig(File dataFolder) throws IOException {
        ...
        if (config.contains("api")) {
            Config.setAPI(config.getBoolean("api"), config.getString("api-link"), config.getString("secret"));
        } else {
            Config.writeAPI(out);
        }
        out.close();
    ...
    private static void setAPI(Boolean api, String string, String secret) {
        Config.api = api;
        Config.link = string;
